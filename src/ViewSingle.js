...
class ViewCourse extends React.Component {
	render() {
		...
		const resourceCards = theseProps.resource.courseData.relatedCoursesResources.map((resource) => {
			return <CardResource resource={resource} handleClick={this.props.handleClick} />
		});
